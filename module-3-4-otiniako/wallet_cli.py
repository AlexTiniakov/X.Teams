...
class Wallet(cmd.Cmd):
    ...
    def do_send(self, line):
        ...
        if len(line) == 2:
            try:
                ...
                self.tr = Transaction(self.addr, [line[0],], [int(line[1]),], self.privkey_WIF)
                print(binascii.hexlify(self.tr.real_tx).decode('utf-8'))
            except IOError:
    ...
    def do_a(self, line):
        ...
        self.do_send("14SNRmJ4BKUqK38aukR3hLzjuxXvU2jqW6 50")
